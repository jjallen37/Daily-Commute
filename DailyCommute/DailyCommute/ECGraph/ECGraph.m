...
-(id)initWithFrame:(CGRect)frame withContext:(CGContextRef)context isPortrait:(BOOL)isPortrait
{
	if (self = [super init]) 
	{
		...
		_defaultColors = [[NSArray alloc] initWithObjects:[UIColor colorWithRed:1 green:0 blue:0 alpha:1],
						  [UIColor colorWithRed:0 green:0 blue:1 alpha:1],[UIColor colorWithRed:1 green:165/255.0 blue:0 alpha:1],
						  [UIColor colorWithRed:128/255.0 green:0 blue:128/255.0 alpha:1],[UIColor colorWithRed:0 green:128/255.0 blue:0 alpha:1],
						  [UIColor colorWithRed:1 green:1 blue:0 alpha:1],  [UIColor colorWithRed:238/255.0 green:130/255.0 blue:238/255.0 alpha:1],
						  [UIColor colorWithRed:153/255.0 green:0 blue:0 alpha:1],[UIColor colorWithRed:0 green:153/255.0  blue:0 alpha:1],
						  [UIColor colorWithRed:0 green:0 blue:153/255.0  alpha:1],[UIColor colorWithRed:220/255.0 green:20/255.0  blue:60/255.0 alpha:1],nil];
...
-(void)drawCurveWithLines:(NSArray *)lines lineWidth:(int)lineWidth color:(UIColor *)color
{
	...
	for (int i = 0; i < [lines count]; ++i) 
	{
		ECGraphLine *line = [lines objectAtIndex:i];
		UIColor *color;
		if (line.color == nil && line.defaultColor == -1) {
			color = [self getRandomColor];
		}
		else if(line.color == nil && line.defaultColor != -1)
		{
			color = [_defaultColors objectAtIndex:line.defaultColor];
		}
		else {
			color = line.color;
		}
...
-(void)drawHistogramWithItems:(NSArray *)items lineWidth:(int)lineWidth color:(UIColor *)color
{
	...
	for (int i = 0; i < itemsCount; ++i) 
	{
		ECGraphItem *item = [items objectAtIndex:i];
		UIColor *color;
		if (item.color == nil && item.defaultColor == -1) {
			color = [self getRandomColor];
		}
		else if(item.color == nil && item.defaultColor != -1)
		{
			color = [_defaultColors objectAtIndex:item.defaultColor];
		}
		else {
			color = item.color;
		}
