//
//  RootViewControllerNewStyleViewController.m
//  DailyCommute
//
...
@implementation RootViewControllerNewStyle
...
- (void)viewDidLoad
{
    ...
    //Information Table
    informationTableViewController = [[NewInfoTableViewController alloc] initWithCommute:self.currentCommute];
    ...
    //Adjust Fonts
    //[timeHoursMinutesLabel setFont:[UIFont fontWithName:@"Chalet" size:78]];
    [timeTodaysDateLabel setFont:[UIFont fontWithName:@"Chalet" size:17]];
    [weatherLabel setFont:[UIFont fontWithName:@"Chalet" size:17]];
    [sorryLabel setFont:[UIFont fontWithName:@"Chalet" size:14]];
    
    titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 90, 200, 440)];
	titleLabel.backgroundColor = [UIColor clearColor];
	titleLabel.font = [UIFont fontWithName:@"Chalet" size:36];
    ...
    for (int i=0; i<365; i++) {
        ...
        route.endTime = [date dateByAddingTimeInterval:arc4random() % 367];
