...
@implementation CommuteSettingsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        ...
        case 1://Arrival Time
            ...
            if (currentCommute.arrivalTime != nil) {
                [cell.timePicker setDate:currentCommute.arrivalTime];
                cell.textField.text = [dateFormatter stringFromDate:currentCommute.arrivalTime];
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    switch (textField.tag) {
        case 0://Name
            ...
            break;
        case 1:
            currentCommute.arrivalTime = ((UIDatePicker *)textField.inputView).date;
            break;
