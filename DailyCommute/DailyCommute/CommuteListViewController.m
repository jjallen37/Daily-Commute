...
@interface CommuteListViewController ()

@end

@implementation CommuteListViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    RecieptViewController *currentRouteReceipt = [[RecieptViewController alloc] initWithRoute:[[self fetchedResultsController] objectAtIndexPath:indexPath]];
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:
                              @"toCommute.name == %@",[userDefaults objectForKey:kCurrentCommuteKey]];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [dateFormatter stringFromDate:object.startTime];
    [dateFormatter setDateFormat:@"h:mm aa"];
    cell.detailTextLabel.text = [dateFormatter stringFromDate:object.startTime];
