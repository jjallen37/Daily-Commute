...
@implementation NewInfoTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *CellIdentifier = @"NewInfoCell";
    
    NewInfoCell *cell = (NewInfoCell *) [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        
        NSArray *topLevelObjects = [[NSBundle mainBundle] loadNibNamed:@"NewInfoCell" owner:self options:nil];
        
        for (id currentObject in topLevelObjects){
            if ([currentObject isKindOfClass:[UITableViewCell class]]){
                cell =  (NewInfoCell *)currentObject;
                break;
            }
        }
    }
    ...
    [cell.infoTitleLabel setFont:[UIFont fontWithName:@"Chalet" size:19]];
    [cell.infoDetailLabel setFont:[UIFont fontWithName:@"Chalet" size:17]];
    switch (indexPath.row) {
        case 1:
            ...
            [cell setInfoCellDetailBarStyle:NewInfoCellDetailBarStyleNormal];
            break;
        case 2:
        ...
        case 0:
            ...
            [cell setInfoCellDetailBarStyle:NewInfoCellDetailBarStyleDepartIn];
...
- (IBAction)updateCountDown:(id)sender {
    ...
    /* // I wanted to update this cell specifically
     NewInfoCell *cell = (NewInfoCell *)[self.tableView cellForRowAtIndexPath:a];
     NSDate *timeToDepart = [commute.toArrivalTime dateByAddingTimeInterval:-(int)[self getAverageTime]];
     NSTimeInterval timeTilDepart = [[NSDate date] timeIntervalSinceDate:timeToDepart];
     //NSLog(@"time to depart - %@",[dateFormatter stringFromDate:timeToDepart]);
